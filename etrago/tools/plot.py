...
def plot_grid(self, line_color, boundaries=None):
        ...
        if line_color=='line_loading':
            ...
            line_colors={'Line':(self.lines_t.p0/self.lines.s_nom_opt).abs().mean(),
                         'Link':(self.links_t.p0/self.links.p_nom_opt).abs().mean()}
            boundaries=[0,1]
            label='line loading in p.u.'
              ...
              label='v_nom in kV'
              line_colors={'Line':self.lines.v_nom,
                           'Link':self.links.v_nom}
              boundaries=[110, 450]
        
        elif line_color=='expansion':
            title='Network expansion'
            label='additional capacity in MW'
            line_colors={'Line':self.lines.s_nom_opt-self.lines.s_nom_min,
                         'Link':self.links.p_nom_opt-self.links.p_nom_min}
        else:
            return
        ...
        ll=self.plot(line_colors=line_colors, 
